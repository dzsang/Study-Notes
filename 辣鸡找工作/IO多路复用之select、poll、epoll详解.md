...
基本流程，如图所示：
![SELECT基本流程](../markdown图片/SELECT基本流程.png)
...
1、支持一个进程所能打开的最大连接数
![支持一个进程所能打开的最大连接数](../markdown图片/支持一个进程所能打开的最大连接数.png)
2、FD剧增后带来的IO效率问题
![FD剧增后带来的IO效率问题](../markdown图片/FD剧增后带来的IO效率问题.png)
3、消息传递方式
![消息传递方式](../markdown图片/消息传递方式.png)
